...
class Settings:
    ...
    google_map_api_key: str | None = os.getenv("GOOGLE_MAP_API_KEY") or None
    tmap_app_key: str | None = os.getenv("SK_TMAP_APP_KEY") or os.getenv("TMAP_APP_KEY") or None
    restaurant_search_radius_m: float = 250.0
    restaurant_max_results: int = 8
    ...
    seoul_streetlight_data_path: str | None = os.getenv("SEOUL_STREETLIGHT_DATA_PATH") or None
    seoul_bike_api_service: str | None = os.getenv("SEOUL_BIKE_API_SERVICE") or None
    kma_data_api_key: str | None = (
        os.getenv("KMA_SERVICE_KEY") or os.getenv("KMA_DATA_API_KEY") or None
    )
